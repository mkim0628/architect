...
> **[승계됨]** 본 문서의 DP1(실행 스택 소싱)·DP2(KV 배치·압축 관리 주체)는
> 1단계(KV 캐시 최적 운용) 5-DP 체계로 **승계·개정**되었다 — 현행 문서는
> [`02_design_points_dp1_dp5.md`](02_design_points_dp1_dp5.md) v1.0 (골격
> 유지, 논거 1단계 교체·QA 신번호 재채점). 본 문서는 구 체계(MCR 전체
> 범위) 기록으로 동결한다.
