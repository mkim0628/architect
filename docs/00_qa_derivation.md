...
| QA5 Modifiability | **M** (3 = 0·1·2) — 1단계 판정 비직결, 수명·2단계 접속점 | **H** (5 = 2·1·2) — MLA·linear attention 수용 경계는 문헌 무해답 + 코어/공개 IF는 불가역 초기 결정 | 5 (M그룹 難 H) |
| QA6 Maintainability | **M 하위** (2 = 0·1·1) — 수명 좌우(R-12)하나 성패 지표 아님 | **M 하위** (2 = 0·1·1) — 표준 산정 방법, plugin 경계 시 관리 가능(02 실측) | 6 |
