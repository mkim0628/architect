...
- DP1–DP5 채택안 결정 및 ADR 작성 — DP1·DP2: [`02_design_points_dp1_dp2.md`](02_design_points_dp1_dp2.md), DP3(KV 재사용 범위·복원)·DP4(topology 추상화 수준)·DP5(P/D KV 이동 구조): [`03_design_points_dp3_dp5.md`](03_design_points_dp3_dp5.md)
