...
| 문서 | 내용 |
|---|---|
| [docs/md/01_architecture_overview.md](docs/md/01_architecture_overview.md) | 패키지 구조 확정안 v2 — 검수 반영 사항, 의존 관계, 미결 사항 |
| [docs/md/02_design_points_dp1_dp2.md](docs/md/02_design_points_dp1_dp2.md) | DP1(Framework 실행 구조)·DP2(KV 배치·압축 관리 주체) — 문제 정의, 후보구조, QA 평가 |
